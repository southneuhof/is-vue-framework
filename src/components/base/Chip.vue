...
<template>
  ...
  <div v-else class="box-border flex h-fit w-fit items-center justify-center rounded-lg bg-surface-container-highest px-2 py-1 text-center text-sm text-on-surface">
    <slot></slot>
  </div>
</template>
