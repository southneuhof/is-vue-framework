...
import { defaultCRUDListOnExport } from '@southneuhof/is-vue-framework/runtimeDefaults'
  ...
  buildListConfig(props.config, {
    ...
    export: {
      ...
      onExport: crudOperations.export
        ...
        : ({ exportAPI, params, listConfig }: any) => defaultCRUDListOnExport({ exportAPI, params, listConfig }, runtime.crudList),
    },
  })
)
