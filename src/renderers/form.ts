...
export const builtInFormRenderers: Record<string, Component> = {
  ...
  currency: legacyInput(() => import('../components/inputs/CurrencyInput.vue')),
  ...
  'file-manager': legacyInput(() => import('../components/composites/form-inputs/FileManager/FileManagerInput.vue')),
