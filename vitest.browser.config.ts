...
export default defineConfig({
  ...
  test: {
    include: ['src/components/core/__tests__/Table.browser.spec.ts', 'src/components/views/__tests__/ListView.browser.spec.ts', 'src/components/base/__tests__/primitives.browser.spec.ts', 'src/components/inputs/__tests__/FileInput.browser.spec.ts'],
    browser: {
      enabled: true,
      headless: true,
      provider: playwright(),
